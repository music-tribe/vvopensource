...
//	MGOSCInPort is Music Group customised version of OSCInPort, designed to be run in single-threaded ios application.
// The main thread function has been replaced by checkForPackets, which should be called frequently by client app
...
*/
@interface MGOSCInPort : NSObject {
...
- (void) start;
- (void) stop;
// call this regularly, in the absence of a receiver thread
